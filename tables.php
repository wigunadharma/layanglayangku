      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <!-- DataTales Example -->
            <a href="#"class="btn btn-success my-3" data-toggle="modal" data-target="#tambah">Tambah Data</a>
                        ...
                        <td>
                          <div class="dropdown mr-1">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a href="hapus.php?id=<?= $row["id"];?>" class="dropdown-item">Hapus</a>
                            </div>
                          </div>
                        </td>
                        <td><?= $row["fname"]?></td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <select class="custom-select" id="level" name="level">
              <option value="petugasl">Petugas Layangan</option>
              <option value="petugase">Petugas Event</option>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <input type="hidden" name="id" value="<?= $row['id'];?>">
              <label for="fname">First Name</label>
              <input type="text" name="fname" class="form-control" id="fname" value="<?= $row["fname"];?>" required>
              <label for="lname">Last Name</label>
              <input type="text" name="lname" class="form-control" id="lname" value="<?= $row["lname"];?>" required>
              <label for="username">Username</label>
